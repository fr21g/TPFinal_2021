...
class Abmcompra{
    ...
    private function cargarObjeto($param){
        ...
        and array_key_exists('preciofinal',$param)){
            $obj = new Compra();
            $idusuario= new Usuario();
            $idusuario->setIdusuario($param['idusuario']);
            $obj->setear($param['idcompra'],$param['cofecha'],$idusuario,$param['preciofinal']);
        }
        return $obj;
    }
...
//        verEstructura($elObjtTabla);
    ...
    public function buscar($param){
        ...
        if ($param<>NULL){
            ...
            if(isset($param['preciofinal']))
                $where.=" and preciofinal =".$param['preciofinal'];
