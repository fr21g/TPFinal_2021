            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="our-link" id="menu">
                        ...
                        ?>  
                        <li ><a href="#"><i class="fa fa-user s_color"><?php  $usuario = $session->getUsuario(); echo $usuario->getUsNombre();?></i></a>
                                    <ul>
                                        <li>
                                        <?php
                                        ...
                                        foreach($menues as $menu){
                                            foreach($roles as $rol){
                                                if($rol == $menu->getMenombre()){
                                                    echo "<br><a href='?rol=".$rol."' >".$rol."</a><br>";
                                                }
                                            }
                                    ...
                                    <?php if($session->activa() && $datouser['rol'] == "administrador"){?>
                                        <a href="../paginas/configCuenta.php?rol=administrador" id='..'><br>Gestion de cuenta</a>
                                    <?php
                                    }
                                    ?>
                            ...
                            ?>
                            <li><a href="#aqui"><i class="fas fa-location-arrow"></i> Donde Estamos</a></li>
                            <li><a href="#aqui"><i class="fas fa-headset"></i> Contactenos</a></li>
                            <li><a ><i class="fas"></i> <?php if($session->activa() && $datouser['rol'] == "administrador"){
                               echo"Rol:"; print_r($datouser['rol']);
                            }elseif($session->activa() && $datouser['rol'] == "deposito"){
                                echo"Rol:"; print_r($datouser['rol']);
                            }elseif($session->activa() && $datouser['rol'] == "cliente"){
                                echo"Rol:";print_r($datouser['rol']);
                            }elseif($session->activa() && $datouser['rol'] == "publico"){
                                echo "elija un rol!";
                            };?></a></li>
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../index/index.php?rol=publico"><img width="65px" src="../images/logo2.png" class="logo" alt=""> Los tres Rabanitos</a>
                </div>
                    ...
                    <?php 
                        ...
                        if(!$session->activa()){ //si la sesion NO esta activa se cargan los menues publicos
                            ...
                            foreach($menuroles as $menurol){
                                if($menurol->getIdrol()->getRodescript() == $datouser['rol']){
                                    foreach($menues as $menu){
                                        if($menurol->getIdmenu()->getIdmenu() == $menu->getIdmenu() && $menurol->getIdmenu()->getIdpadre() != NULL){
                                            echo "<li class='nav-item active'><a href='".$menu->getMedescripcion()."?rol=".$datouser['rol']."'>".$menu->getMenombre()."</a></li>";
                                        }
                                    }
                                }
