            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Los tres Rabanitos tiene una gran varidad de procutos, puede elegir el que le guste</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".bulbs">Bulbos</button>
                            <button data-filter=".fruits">Frutas</button>
							<button data-filter=".podded-vegetables">Verduras en baina</button>
							<button data-filter=".root-and-tuberous">Raiz y tuberosa</button>
                        </div>
                    </div>
                </div>
            </div>
